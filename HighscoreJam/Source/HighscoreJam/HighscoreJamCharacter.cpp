...
AHighscoreJamCharacter::AHighscoreJamCharacter()
{
...
void AHighscoreJamCharacter::NotifyControllerChanged()
{
...
void AHighscoreJamCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AHighscoreJamCharacter::Move);

		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &AHighscoreJamCharacter::Look);
	}
	else
	{
...
void AHighscoreJamCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AHighscoreJamCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
